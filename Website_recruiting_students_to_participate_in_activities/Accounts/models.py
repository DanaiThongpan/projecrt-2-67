...
class UserStudent(models.Model):
    ...
    number_of_credits_required1 = models.IntegerField(default=0)
    number_of_credits_available1 = models.IntegerField(default=0)
    number_of_credits_required2 = models.IntegerField(default=0)
    number_of_credits_available2 = models.IntegerField(default=0)
    number_of_credits_required3 = models.IntegerField(default=0)
    number_of_credits_available3 = models.IntegerField(default=0)
    number_of_credits_required4 = models.IntegerField(default=0)
    number_of_credits_available4 = models.IntegerField(default=0)
    number_of_credits_required5 = models.IntegerField(default=0)
    number_of_credits_available5 = models.IntegerField(default=0)
    number_of_credits_required6 = models.IntegerField(default=0)
    number_of_credits_available6 = models.IntegerField(default=0)
